...
output.elasticsearch:
  ...
  #api_key: "id:api_key"
  username: "elastic"
  password: "eaPLu=HXMoSVfBxB2kkR"
  ssl.verification_mode: "none"

*La ligne ssl.verification_mode: "none" permet de bypasser la vérification des certificats afin de ne pas avoir l'erreur indiquant que la CA est inconnue*
